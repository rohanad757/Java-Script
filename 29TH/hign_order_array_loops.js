...
//     console.log(i);           //Will give myObj is not Iterable , we can apply for-of on object , to iterate over object we can use for-in loop ar rater iterate on for-of itself we need to access it like Object.keys(myObj)
// }
...
//     'game3': "COD",
// }
// for (const i of Object.entries(myObj)) {           // // Similarly we can also do for keys,values
//     console.log(i);           
// }
...
// for (const i in prog) {
// // console.log(i);      //Here in the for-in in array for key it will give the index
// console.log(prog[i]);
// }
// //  /// /// // /// /// / Since Maps are also not iterable i n for-in loop hence cant use 
